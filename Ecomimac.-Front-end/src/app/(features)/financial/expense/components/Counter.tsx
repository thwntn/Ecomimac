...
import { CounterExpenseCategoryResponse } from "@/utils/interface"
import { Fragment } from "react"

const Counter = () => {
  const counter = useGet<CounterExpenseCategoryResponse>(
    RouteMap.EXPENSE_CATEGORY + "/" + RouteMap.COUNTER
  )

  const isLoad = convert(!counter.response)
  return (
    <Row gap={16}>
